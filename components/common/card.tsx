...
const Card = () => {
  return (
    <div className="w-full min-w-[267px] h-[418px] rounded-[10px] border-[3px] border-[#ffffff17] relative overflow-hidden group ">
      <div className="bg-[url('https://cima4uu.quest/wp-content/uploads/075-3580.jpg')] scale-100  group-hover:scale-125 transition-all duration-300 group-hover:transition-all group-hover:duration-500 w-full h-full bg-center bg-no-repeat bg-cover cursor-pointer">
      </div>
